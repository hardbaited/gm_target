...
## ⚠️ Pre-Release ⚠️
This Script is a fork of [meta_target](https://github.com/meta-hub/meta_target/tree/main)
...
This script works better and is more optimized compared to the default rsg-target.

## Installation:  
Download the latest release of `gm_target`.  
Add the `gm_target` resource to your `resources` folder, and add `start gm_target` to your server.cfg.  
...
`client_script '@gm_target/lib/target.lua'`  
